    ...
    <div className="flex h-screen bg-gray-100">
        ...
        <div className="flex flex-col h-full">
          <div className="p-4 ">
            <Link to="/" className="flex text-2xl items-center gap-2 font-bold text-blue-600">
              ...
              <span class="font text-3xl ">Girl Grievance </span>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white border shadow-sm z-20">
          <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex md:justify-between  justify-between items-center">
